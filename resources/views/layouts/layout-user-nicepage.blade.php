            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="mr-auto navbar-nav" style="padding-left: 2%;">
                        ...
                        <h3 class="" style=" text-align: center;color: #000">Sistem Bantuan Kewangan Rumah Ibadat
                            Selain Islam</h3>
                    ...
                    <ul class="float-right navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <span data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <button class="btn btn-light" style="border: solid black 1px;" data-toggle="tooltip"
                                    data-placement="left" title="" data-original-title="Profil">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                href="{{ route('user.halaman-utama') }}" aria-expanded="false"><i
                                    class="icon-home"></i><span class="hide-menu">Halaman Utama </span></a>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('users.rumah-ibadat.kemaskini') }}"
                                        aria-expanded="false"><span class="hide-menu">Kemaskini Profil Rumah
                                            Ibadat</span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('users.permohonan.baru') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Baru</span></a>

                                </li>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('users.permohonan.sedang-diproses') }}"
                                        aria-expanded="false"><span class="hide-menu">Permohonan Sedang
                                            Diproses</span></a>

                                </li>
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('users.permohonan.lulus') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Lulus</span></a>

                                </li>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('users.permohonan.tidak-lulus') }}"
