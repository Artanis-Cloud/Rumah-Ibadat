                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                href="{{ route('ybs.dashboard') }}" aria-expanded="false"><i
                                    class="fas fa-tachometer-alt"></i><span class="hide-menu"
                                    style="padding-left: 10px;">Dashboard </span></a></li>

                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="far fa-list-alt"></i><span
                                    class="hide-menu" style="padding-left: 10px;">Permohonan</span></a>
                            <ul aria-expanded="false" class="collapse first-level">

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.baru') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Baru</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.sedang-diproses') }}"
                                        aria-expanded="false"><span class="hide-menu">Permohonan Sedang
                                            Diproses</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.semak-semula') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Semakan Semula</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.lulus') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Lulus</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.tidak-lulus') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Tidak Lulus</span></a>

                                    <hr>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.status-permohonan') }}"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.khas') }}" aria-expanded="false"><span
                                            class="hide-menu">Senarai Permohonan Khas</span></a>

                                    <hr>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.permohonan.khas.status-permohonan') }}"
                                        aria-expanded="false"><span class="hide-menu">Status Permohonan
                                            Keseluruhan</span></a>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('ybs.rumah-ibadat.senarai') }}" aria-expanded="false"><span
