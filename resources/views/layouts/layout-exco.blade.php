                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                href="{{ route('excos.dashboard') }}" aria-expanded="false"><i
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.baru') }}" aria-expanded="false"><span
                                            class="hide-menu">Senarai Permohonan Baru</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.sedang-diproses') }}"
                                        aria-expanded="false"><span class="hide-menu">Senarai Permohonan Sedang
                                            Diproses</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.semakan-semula') }}"
                                        aria-expanded="false"><span class="hide-menu">Senarai Permohonan Semakan
                                            Semula</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.lulus') }}" aria-expanded="false"><span
                                            class="hide-menu">Senarai Permohonan Lulus</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.tidak-lulus') }}"
                                        aria-expanded="false"><span class="hide-menu">Senarai Permohonan Tidak
                                            Lulus</span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.khas') }}" aria-expanded="false"><span
                                            class="hide-menu">Senarai Permohonan Khas</span></a>

                                    <hr>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.permohonan.khas.status-permohonan') }}"
                                        aria-expanded="false"><span class="hide-menu">Status Permohonan
                                            Keseluruhan</span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('excos.rumah-ibadat.senarai') }}" aria-expanded="false"><span
