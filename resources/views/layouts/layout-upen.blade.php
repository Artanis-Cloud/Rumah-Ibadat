                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="text-white d-flex no-block align-items-center p-15 bg-dark m-b-10"
                                    ...
                                    <div class="m-l-10">
                                        ...
                                        <p style="margin-bottom: 0px !important;"><i
                                                class="fas fa-crown"></i>&nbsp&nbsp&nbspPejabat Upen</p>
                                    </div>
                                </div>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                href="{{ route('upens.dashboard') }}" aria-expanded="false"><i
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="fas fa-users"></i><span
                                    class="hide-menu" style="padding-left: 10px;">Permohonan</span></a>
                            <ul aria-expanded="false" class="collapse first-level">

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan.baru') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Baru</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan.semak-semula') }}"
                                        aria-expanded="false"><span class="hide-menu">Permohonan Semakan
                                            Semula</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan.lulus') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Lulus</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan.tidak-lulus') }}"
                                        aria-expanded="false"><span class="hide-menu">Permohonan Tidak
                                            Lulus</span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="fas fa-file-alt"></i><span
                                    class="hide-menu" style="padding-left: 10px;">Permohonan Khas</span></a>
                            <ul aria-expanded="false" class="collapse first-level">

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan-khas.baru') }}" aria-expanded="false"><span
                                            class="hide-menu">Permohonan Khas</span></a>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan-khas.senarai') }}"
                                        aria-expanded="false"><span class="hide-menu">Senarai Permohonan
                                            Khas</span></a>

                                    <hr>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.permohonan.khas.status-permohonan') }}"
                                        aria-expanded="false"><span class="hide-menu">Status Permohonan
                                            Keseluruhan</span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.tetapan.permohonan') }}" aria-expanded="false"><span
                                            class="hide-menu">Tetapan Permohonan</span></a>
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        href="{{ route('upens.tetapan.pengumuman') }}" aria-expanded="false"><span
                                            class="hide-menu">Tetapan Pengumuman</span></a>
