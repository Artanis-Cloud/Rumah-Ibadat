                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="card-body border border-primary">
                                                ...
                                                <div class="col-md">
                                                    ...
                                                    <div class="mb-3 input-group">
                                                        <input
                                                            ...
                                                            value="{{ $permohonan->rumah_ibadat->category == 'TOKONG' ? 'TOKONG (BUDDHA & TAO)' : ($permohonan->rumah_ibadat->category == 'KUIL' ? 'KUIL (HINDU)' : ($permohonan->rumah_ibadat->category == 'GURDWARA' ? 'KUIL (GURDWARA)' : ($permohonan->rumah_ibadat->category == 'GEREJA' ? 'GEREJA (KRISTIAN)' : 'ERROR DATA'))) }}"
                                                            disabled>
                                                    </div>
                                            ...
                                            @elseif($permohonan->rumah_ibadat->registration_type == "INDUK")
                                                ...
                                                <div class="row">
                                                    <div class="col-md">
                                                        <label>Nama Persatuan Rumah Ibadat
                                                            Induk</label>
                                                        <div class="form-group">
                                                            <textarea class="form-control text-uppercase  border-dark "
                                            ...
                                            <div class="row">
                                                    <div class="col-md">
                                                        <label>Nama Penuh Persatuan Rumah Ibadat Mengikut Pendaftaran
                                                        Bank</label>
                                                        <div class="form-group">
                                                            <textarea class="form-control text-uppercase  border-dark "
                                                                id="name_association_bank" name="name_association_bank"
                                                                rows="3"
                                ...
                                <div class="card">
                                    <a href="" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false"
                                        ...
                                        <div class="card-header bg-dark" id="headingOne">
                                            <h4 class="mb-0">&nbsp<i
                                                    class="fas fa-history"></i>&nbsp&nbsp&nbspSejarah Permohonan</h4>
                                        </div>
                                    </a>
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody style="text-align: center;">
                                                                ...
                                                                @foreach ($history_application_system as $key => $data)
                                                                    ...
                                                                    <tr>
                                                                        <td><i class="far fa-check-circle"
                                                                                style="color: green;"></i></td>
                                                                        <td>{{ Carbon\Carbon::parse($data->created_at)->format('Y') }}
                                                                        </td>
                                                                        <td>{{ $data->rumah_ibadat->name_association }}
                                                                        </td>
                                                                        <td>RM {{ number_format($data->total_fund, 2) }}
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                @if ($history_application_system->isEmpty() && $sejarah_permohonan == null)
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="text-center">
                                                                            <img src="https://image.flaticon.com/icons/png/128/1376/1376786.png"
                                                                                alt="" width="100px">
                                                                            <br>
                                                                            <b>Maaf, rumah ibadat ini tiada sejarah
                                                                                permohonan</b>
                                                                        </td>
                                                                    </tr>
                                ...
                                <div class="card">
                                    <a href="" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false"
                                        ...
                                        <div class="card-header bg-info" id="headingFive">
                                            <h4 class="mb-0">&nbsp<i
                                                    class="fas fa-gavel"></i>&nbsp&nbsp&nbspUlasan & Keputusan</h4>
                                        </div>
                                    </a>
                          ...
                          <div class="col-md-2"></div>
                                                ...
                                                <div class="col-md">
                                                    <form action="{{ route('excos.permohonan.print') }}" target="_blank">
                                                        <input type="hidden" name="permohonan_id"
                                                            value="{{ $permohonan->id }}" readonly>
                                                        <button type="submit"
                                                            class="btn waves-effect waves-light btn-info btn-block"><i
                                                                class="fas fa-print"></i> &nbsp&nbsp Cetak
                                                            Permohonan</button>
                                                    </form>
                                                </div>
                                                <div class="col-md-2"></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" style="padding-top: 15px;">
                                                    <button type="button"
                                                        class="btn waves-effect waves-light btn-warning text-dark btn-block"
                                                        id="semak_semula_button" data-toggle="modal"
                                                        data-target="#confirmation_review_application">Semak Semula</button>
                                                </div>
                                                <div class="col-md-4" style="padding-top: 15px;">
                                                    <button type="button"
                                                        class="btn waves-effect waves-light btn-danger btn-block"
                                                        id="batal_button" data-toggle="modal"
                                                        data-target="#confirmation_batal_permohonan">Tidak Lulus</button>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                                            ...
                                            <div class="row" style="padding-top: 10px;">
                                                ...
                                                <div class="col-md" style="padding-top: 5px;">
                                                    <button type="button"
                                                        class="btn waves-effect waves-light btn-success btn-block"
                                                        id="sahkan_button" data-toggle="modal"
                                                        data-target="#confirmation_luluskan_permohonan">Sahkan
                                                        Permohonan</button>
                                                </div>
                                                <div class="col-md-2"></div>
                                            </div>
                            ...
                            <!-- Modal Confirmation -->
                            <div class="modal fade" id="confirmation_luluskan_permohonan" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('excos.permohonan.papar.sahkan') }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <h4>Cadangan Peruntukan Dana</h4>
                                                ...
                                                <div class="row">
                                                    <div class="col-md">
                                                        <div class="card text-white">
                                                            <div class="card-header bg-dark">
                                                                <h4 class="m-b-0 text-white" style="text-align: center;">
                                                                    Ulasan Wakil Pejabat Exco</h4>
                                                            </div>
                                                            <div class="card-body border border-dark">
                                                                <textarea class="form-control text-uppercase  border-dark "
                                                                    id="review_exco" name="review_exco" rows="6"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-success">Mengesahkan
                                                    Permohonan</button>
                                            </div>
                            ...
                            <!-- Modal Rejection -->
                            <div class="modal fade" id="confirmation_batal_permohonan" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            {{-- Modal Semak Semula --}}
                            <div class="modal fade" id="confirmation_review_application" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form action="{{ route('excos.permohonan.papar.semak-semula') }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md">Sila pilih <b>(Minimum 1)</b> bahagian yang
                                                        perlu disemak semula oleh pemohon?</div>
                                                </div>
                          ...
                          <fieldset class="checkbox">
                              <label>
                                  ...
                                  Maklumat Rumah Ibadat Tidak Sah
                                                ...
                                                <div class="row">
                                                    <div class="col-md">
                                                        <label style="padding-bottom: 10px;">Dokumen-dokumen
                                                            lampiran</label>
                                                        <fieldset class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="application_letter"
                                                                    id="review_2" name="review[]"
                                                                    onclick="semak_semula_validation()">
                                                                @if ($permohonan->rumah_ibadat->category == 'KUIL' || $permohonan->rumah_ibadat->category == 'GURDWARA')
                                                                    Kertas Kerja Permohonan Peruntukan Bagi Tahun Semasa Dan
                                                                    Sebut Harga
                                                                @else
                                                        ...
                                                        <fieldset class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="registration_certificate"
                                                                    id="review_3" name="review[]"
                                                                    onclick="semak_semula_validation()">
                                                                @if ($permohonan->rumah_ibadat->category == 'KUIL' || $permohonan->rumah_ibadat->category == 'GURDWARA')
                                                                    Sijil Pendaftaran (Akta Pertubuhan 1966)
                                                                @else
                                                        ...
                                                        <fieldset class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="account_statement"
                                                                    id="review_4" name="review[]"
                                                                    onclick="semak_semula_validation()">
                                                                Penyata Bank
                                                            </label>
                                                        </fieldset>
                                                        ...
                                                        @if ($permohonan->rumah_ibadat->category == 'KUIL' || $permohonan->rumah_ibadat->category == 'GURDWARA')
                                                            <fieldset class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" value="spending_statement"
                                                                        id="review_5" name="review[]"
                                                                        onclick="semak_semula_validation()">
                                                                    Penyata Perbelanjaan
                                                                </label>
                                                            </fieldset>
                                                            ...
                                                            <fieldset class="checkbox">
                                                                <label>
                                                                    <input type="checkbox" value="support_letter"
                                                                        id="review_6" name="review[]"
                                                                        onclick="semak_semula_validation()">
                                                                    Surat Sokongan Daripada Adun Kawasan / Ahli Parlimen /
                                                                    Penyelaras Dun / Ahli Majlis / Ketua Komuniti India
                                                                </label>
                                                            </fieldset>
                                                        @endif
                                                    </div>
                                                        ...
                                                        @foreach ($permohonan->tujuan as $key => $tujuan)
                                                            ...
                                                            @if ($tujuan->tujuan == 'AKTIVITI KEAGAMAAN')
                                                                <fieldset class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox"
                                                                            value="{{ $tujuan->tujuan }}" id="review_7"
                                                                            name="review[]"
                                                                            onclick="semak_semula_validation()">
                                                                        {{ $tujuan->tujuan }}
                                                                    </label>
                                                            ...
                                                            @if ($tujuan->tujuan == 'PENDIDIKAN KEAGAMAAN')
                                                                <fieldset class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox"
                                                                            value="{{ $tujuan->tujuan }}" id="review_8"
                                                                            name="review[]"
                                                                            onclick="semak_semula_validation()">
                                                                        {{ $tujuan->tujuan }}
                                                                    </label>
                                                            ...
                                                            @if ($tujuan->tujuan == 'PEMBELIAN PERALATAN UNTUK KELAS KEAGAMAAN')
                                                                <fieldset class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox"
                                                                            value="{{ $tujuan->tujuan }}" id="review_9"
                                                                            name="review[]"
                                                                            onclick="semak_semula_validation()">
                                                                        {{ $tujuan->tujuan }}
                                                                    </label>
                                                            ...
                                                            @if ($tujuan->tujuan == 'BAIK PULIH/PENYELENGGARAAN BANGUNAN')
                                                                <fieldset class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox"
                                                                            value="{{ $tujuan->tujuan }}" id="review_10"
                                                                            name="review[]"
                                                                            onclick="semak_semula_validation()">
                                                                        {{ $tujuan->tujuan }}
                                                                    </label>
                                                            ...
                                                            @if ($tujuan->tujuan == 'PEMINDAHAN/PEMBINAAN BARU RUMAH IBADAT')
                                                                <fieldset class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox"
                                                                            value="{{ $tujuan->tujuan }}" id="review_11"
                                                                            name="review[]"
                                                                            onclick="semak_semula_validation()">
                                                                        {{ $tujuan->tujuan }}
                                                                    </label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md">
                                                        <div class="card text-white">
                                                            <div class="card-header bg-dark">
                                                                <h4 class="m-b-0 text-white" style="text-align: center;">
                                                                    Ulasan Kepada Pemohon</h4>
                                                            </div>
                                                            <div class="card-body border border-dark">
                                                                <textarea class="form-control text-uppercase  border-dark "
                                                                    id="review_to_applicant" name="review_to_applicant"
                                                                    rows="6"
                                                                    oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);"></textarea>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger"
                                                    data-dismiss="modal">Kembali</button>
                                                <button type="submit" class="btn btn-success" id="semak_semula_enable"
                                                    style="display: none">Semak Semula</button>
                                                <button type="button" class="btn btn-dark" id="semak_semula_disable"
                                                    style="display: block" data-toggle="tooltip" data-placement="top"
                                                    title="Sila tandakan bahagian yang perlu disemak">Semak Semula</button>
                                            </div>
