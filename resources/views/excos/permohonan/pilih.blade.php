        ...
        <div class="row">
          ...
          <div class="col-md" style="padding-top: 20px;">
            <div class="border card border-info h-100">
              ...
              <div class="card-footer">
                <a href="{{ route('excos.permohonan.sedang-diproses') }}" class="btn btn-info">Senarai Sedang Diproses</a>
              </div>
            </div>
          </div>
          {{-- <div class="col-md-1"></div> --}}
        ...
        <div class="row">
          <div class="col-md" style="padding-top: 20px;">
            <div class="border card border-info h-100">
              ...
              <div class="card-footer">
                <a href="{{ route('excos.permohonan.semakan-semula') }}" class="btn btn-info">Senarai Permohonan Semakan Semula</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md" style="padding-top: 20px;">
            <div class="border card border-info h-100">
              <div class="card-body">
                  ...
                  <p class="card-text">Senarai permohonan yang telah diluluskan oleh Pejabat YB dan Kakitangan UPEN.</p>
              </div>
              <div class="card-footer">
                <a href="{{ route('excos.permohonan.lulus') }}" class="btn btn-info">Senarai Permohonan Lulus</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6" style="padding-top: 20px;">
            <div class="border card border-info h-100">
              <div class="card-body">
                  ...
                  <p class="card-text">
                    Senarai permohonan yang tidak diluluskan oleh Pejabat YB dan Kakitangan UPEN.
                  </p>
              </div>
              <div class="card-footer">
                <a href="{{ route('excos.permohonan.tidak-lulus') }}" class="btn btn-info">Senarai Permohonan Tidak Lulus</a>
              </div>
            </div>
          </div>
        </div>
