      ...
      <div class="col-12">
          <div class="card">
                          ...
                          <div class="col-md">
                            <div class="card text-white">
                                ...
                                <div class="card-body border border-dark">
                                    <textarea class="form-control text-uppercase  border-dark " id="review_exco" name="review_exco" rows="6" disabled>{{ $permohonan->review_exco }}</textarea>
                                </div>
                            </div>
                          </div>
                          <div class="col-md-1"></div>
            ...
            <div class="row" style="padding-bottom: 25px; padding-top: 25px;">
              ...
              <div class="col-md">
                <a href="{{ route('excos.permohonan.lulus') }}" class="btn waves-effect waves-light btn-info btn-block">Kembali</a>
              </div>
              <div class="col-md-4"></div>
            </div>
