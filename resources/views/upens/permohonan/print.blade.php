                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <fieldset class="checkbox">
                                <label>
                                    <input type="checkbox" id="lampiran_permohonan_checkbox" checked> Lampiran Permohonan
                                </label>
                            </fieldset>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Nombor Batch</td>
                                        <td>Batch {{ $permohonan->batch }} - {{ $permohonan->rumah_ibadat->category }} </td>
                                    </tr>
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ Carbon\Carbon::parse($permohonan->upen_date_time)->format('d-m-Y') }}</td>
                                    </tr>
                                    <tr>
                                        <td>Waktu Diluluskan</td>
                                        <td>{{ Carbon\Carbon::parse($permohonan->upen_date_time)->format('g:i a') }}</td>
                                    </tr>
                                    @endif
