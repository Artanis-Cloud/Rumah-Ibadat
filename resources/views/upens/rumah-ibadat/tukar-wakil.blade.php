                          ...
                          <tbody>
                            ...
                            @foreach( $permohonan as $data)
                              <tr>
                                  ...
                                  <td>
                                    @if($data->status == "0")
                                      <span class="badge badge-danger" style="font-size: 13px;">Tidak Diluluskan</span>
                                    @elseif($data->status == "1")
                                      <span class="badge badge-warning" style="font-size: 13px;">Sedang Diproses</span>
                                    @elseif($data->status == "2")
                                      <span class="badge badge-success" style="font-size: 13px;">Diluluskan</span>
                                    @endif
                                  </td>
                                  ...
                                  {{-- TINDAKAN --}}
                                  <td>
                                    <form action="{{ route('upens.rumah-ibadat.permohonan.papar') }}">
