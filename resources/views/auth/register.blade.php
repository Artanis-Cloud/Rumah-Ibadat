                ...
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        ...
                        <div class="p-4 login-wrap p-lg-5">
                            ...
                            <div class="d-flex">
                                <div class="w-100">
                                    <h3 class="mb-4 text-center">Daftar Masuk</h3>
                                </div>
                            </div>
                            <form method="POST" id="register_form" action="{{ route('register') }}">
                                ...
                                <div class="mb-3 input-group">
                                    <input name="name" type="text"
                                        ...
                                        autofocus placeholder="Nama" value="{{ old('name') }}"
                                ...
                                <div class="mb-3 input-group">
                                    <input name="email" type="text"
                                        ...
                                        autofocus placeholder="Emel" value="{{ old('email') }}">
                                    @if ($errors->has('email'))
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3 input-group">
                                    <input name="ic_number" type="text"
                                        class="form-control{{ $errors->has('ic_number') ? ' is-invalid' : '' }}" required
                                        autofocus placeholder="Kad Pengenalan" value="{{ old('ic_number') }}"
                                        minlength="12" maxlength="12" onkeypress="return onlyNumberKey(event)">
                                ...
                                <div class="mb-3 input-group">
                                    <div class="mb-3 input-group">
                                        <input name="mobile_phone" type="text"
                                            ...
                                            required autofocus placeholder="Nombor Telefon Bimbit"
                                ...
                                <div class="col-md" style="text-align: center;">
                                    <div class="form-group">
                                        <button type="submit" class="px-3 form-control btn btn-primary submit"
                                            id="roll_submit">Daftar</button>
                                    </div>
                                    <div class="form-group d-md-flex">
                                        <div class="w-100 text-md-center">
                                            <span>
                                                Sudah mempunyai akaun?
                                                <a href="{{ route('login') }}"> Log Masuk Disini.</a>
                                            </span>
                                        </div>
                                    </div>
                                </div>
