            ...
            <form action="{{ route('admins.rumah-ibadat.senarai.update') }}">
              ...
              <div class="card-body border border-dark">
                  ...
                  <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md">
                      <label>Nama Wakil Rumah Ibadat</label>
                      <div class="mb-3 input-group">
                        <input class="form-control text-uppercase border-dark" type="text" value="{{ $rumah_ibadat->user->name }}" readonly>
                    </div>
                    </div>
                    <div class="col-md-2"></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md">
                      ...
                      <div class="mb-3 input-group">
                          <input class="form-control text-uppercase border-dark" type="text" value="{{ $rumah_ibadat->user->ic_number }}" readonly>
                      </div>
                    </div>
                    ...
                    <div class="col-md">
                      ...
                      <div class="input-group">
                        <div class="input-group">
                            <input class="form-control text-uppercase border-dark" type="text" value="{{ $rumah_ibadat->user->mobile_phone }}" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-2"></div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md">
                        <label>Emel</label>
                        <div class="mb-3 input-group">
                            <input class="form-control border-dark" type="email" value="{{ $rumah_ibadat->user->email }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-2"></div>
                  </div>
                  ...
                  <div class="row" style="padding-top: 35px;"> 
                    ...
                    <div class="col-md text-center">
                      ...
                      <h4>Rumah Ibadat Ini Tiada Wakil</h4>
                    </div>
                    <div class="col-md-2"></div>
                  </div>
