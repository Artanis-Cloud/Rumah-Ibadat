...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <div class="col-12">
          <div class="card">
            <form action="{{ route('admins.pengguna.pengguna-dalaman.kemaskini-maklumat-pengguna.kemaskini') }}">
              <div class="card-body border border-dark">
                ...
                <div class="row" style="padding-top: 15px;">
                  ...
                  <div class="col-md">
                    ...
                    <div class="form-group mb-3">
                        <input class="form-control text-uppercase  border-dark " id="name" name="name" value="{{ $user->name }}" type="text" oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                    </div>
                  </div>
                  <div class="col-md">
                ...
                <div class="row">
                  ...
                  <div class="col-md">
                    ...
                    <div class="form-group mb-3">
                        <input class="form-control text-uppercase  border-dark " id="ic_number" name="ic_number" value="{{ $user->ic_number }}" type="text" minlength="12" maxlength="12" onkeypress="return onlyNumberKey(event)">
                    </div>
                  </div>
                  <div class="col-md">
                    <label class="required">Telefon Bimbit</label>
                    <div class="form-group mb-3">
                        <input class="form-control text-uppercase  border-dark " id="phone" name="phone" value="{{ $user->mobile_phone }}" type="text" minlength="10" maxlength="11" onkeypress="return onlyNumberKey(event)">
                    </div>
                  </div>
                  <div class="col-md-2"></div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <select class="custom-select mr-sm-2  border-dark " id="role" name="role" onchange="display_rumah_ibadat()" value="{{ $user->role }}">
                ...
                <div class="row" >
                  ...
                  <div class="col-md-4" id="div_rumah_ibadat_1" style="display: none;">
                    ...
                    <fieldset class="checkbox">
                        <label>
                            <input type="checkbox" value="tokong" id="tokong" name="rumah_ibadat[]" @if($user->role == "1" || $user->role == "2"){{ $user->user_role->tokong == "1"   ? 'checked' : '' }}@endif> Tokong
                        </label>
                    </fieldset>
                    <fieldset class="checkbox">
                        <label>
                            <input type="checkbox" value="kuil" id="kuil" name="rumah_ibadat[]" @if($user->role == "1" || $user->role == "2"){{ $user->user_role->kuil == "1"   ? 'checked' : '' }}@endif> Kuil
                        </label>
                    </fieldset>
                  </div>
                  <div class="col-md-4" id="div_rumah_ibadat_2" style="display: none;">
                    ...
                    <fieldset class="checkbox">
                        <label>
                            <input type="checkbox" value="gurdwara" id="gurdwara" name="rumah_ibadat[]" @if($user->role == "1" || $user->role == "2"){{ $user->user_role->gurdwara == "1"   ? 'checked' : '' }}@endif> Gurdwara
                        </label>
                    </fieldset>
                    <fieldset class="checkbox">
                        <label>
                            <input type="checkbox" value="gereja" id="gereja" name="rumah_ibadat[]" @if($user->role == "1" || $user->role == "2"){{ $user->user_role->gereja == "1"   ? 'checked' : '' }}@endif> Gereja
                        </label>
                    </fieldset>
                  </div>
                  <div class="col-md-2"></div>
                ...
                <div class="row"  style="padding-top: 20px;">
                  <div class="col-md-2"></div>
                  <div class="col-md">
                    <button type="button" class="btn waves-effect waves-light btn-info btn-block" id="validation_button">Kemaskini Maklumat Pengguna</button>
                  </div>
                  <div class="col-md-2"></div>
                </div>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        Anda pasti mahu mengemaskini maklumat pengguna ini?
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Kembali</button>
                        <button type="submit" class="btn btn-success">Kemaskini Maklumat Pengguna</button>
                      </div>
                    </div>
                  </div>
                </div>
...
<script>
  window.addEventListener('load', display_rumah_ibadat_reload);

  function display_rumah_ibadat_reload(){
    var role = $('#role').val();

    console.log("masuk " + role);
