...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <form method="post" action="{{ route('users.permohonan.semak-semula.hantar') }}"
                        ...
                        <div class="border card-body border-dark">
                                ...
                                <div class="col-md">
                                    <div class="text-white card">
                                        <div class="card-header bg-dark">
                                            <h4 class="text-white m-b-0" style="text-align: center;">Ulasan Kepada Pemohon
                                            </h4>
                                        </div>
                                        <div class="border card-body border-dark">
                                            <textarea class="form-control text-uppercase border-dark "
                                                id="review_to_applicant" name="review_to_applicant" rows="6"
                                                oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);"
                                                disabled>{{ $permohonan->review_to_applicant }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2"></div>
                            ...
                            <div class="row" style="padding-top: 15px;">
                                ...
                                <div class="col-md">
                                    <div class="card-header"
                                        ...
                                        <h5>Arahan:</h5>
                                        <span>- Bahagian yang bertanda (<label class="required"></label>) wajib di isi
                                            oleh pemohon.</span>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md" style="display: none;">
                                    ...
                                    <div class="mb-3 form-group">
                                        <input class="text-white form-control text-uppercase border-dark bg-danger"
                                            id="permohonan_id" name="permohonan_id" type="text"
                                ...
                                <div class="col-md" style="display: none;">
                                    ...
                                    <div class="mb-3 form-group">
                                        <input class="text-white form-control text-uppercase border-dark bg-danger"
                                            ...
                                            value="{{ $permohonan->rumah_ibadat->category }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-2"></div>
                            </div>
                            ...
                            @foreach ($permohonan->tujuan as $key => $tujuan)
                                ...
                                @if ($tujuan->tujuan == 'PENDIDIKAN KEAGAMAAN' && $tujuan->status == 2)
                                    ...
                                    <input type="hidden" id="tujuan_2" name="tujuan_2" value="PENDIDIKAN KEAGAMAAN"
                                        disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2"></div>
                                        <div class="col-md">
                                            <label class="required">Senarai nama murid, kad pengenalan, jantina dan
                                                umur murid</label>
                                            <div class="custom-file">
                                ...
                                @if ($tujuan->tujuan == 'PEMBELIAN PERALATAN UNTUK KELAS KEAGAMAAN' && $tujuan->status == 2)
                                    ...
                                    <input type="hidden" id="tujuan_3" name="tujuan_3"
                                        value="PEMBELIAN PERALATAN UNTUK KELAS KEAGAMAAN" disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input-image"
                                                            id="opt_3_photo1" name="opt_3_photo[]">
                                                        <label class="custom-file-label border-dark"
                                                            for="opt_3_photo1">Muat Naik Gambar</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2"></div>
                                ...
                                @if ($tujuan->tujuan == 'BAIK PULIH/PENYELENGGARAAN BANGUNAN' && $tujuan->status == 2)
                                    ...
                                    <input type="hidden" id="tujuan_4" name="tujuan_4"
                                        value="BAIK PULIH/PENYELENGGARAAN BANGUNAN" disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input-image"
                                                            id="opt_4_photo1" name="opt_4_photo[]">
                                                        <label class="custom-file-label border-dark"
                                                            for="opt_4_photo1">Muat Naik Gambar</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2"></div>
                                    ...
                                    <div class="row" style="display: none;">
                                        ...
                                        <div class="col-md">
                                            ...
                                            <div class="mb-3 form-group">
                                                <input class="text-white form-control text-uppercase border-dark bg-danger"
                                                    id="total_opt_4_2_photo" name="total_opt_4_2_photo" type="text"
                                                    value="1" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-2"></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input-image"
                                                            id="opt_4_2_photo1" name="opt_4_2_photo[]">
                                                        <label class="custom-file-label border-dark"
                                                            for="opt_4_2_photo1">Muat Naik Gambar</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2"></div>
                                ...
                                @if ($tujuan->tujuan == 'PEMINDAHAN/PEMBINAAN BARU RUMAH IBADAT' && $tujuan->status == 2)
                                    ...
                                    <input type="hidden" id="tujuan_5" name="tujuan_5"
                                        value="PEMINDAHAN/PEMBINAAN BARU RUMAH IBADAT" disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input-image"
                                                            id="opt_5_photo1" name="opt_5_photo[]">
                                                        <label class="custom-file-label border-dark"
                                                            for="opt_5_photo1">Muat Naik Gambar</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2"></div>
                            ...
                            <div class="row" style="padding-top: 25px;">
                                ...
                                <div class="col-md-6" style="text-align: center;">
                                    <button type="button" id="validation_button"
                                        class="btn waves-effect waves-light btn-info btn-block">Hantar Semula
                                        Permohonan</button>
                                </div>
                                <div class="col-md-3"></div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $(wrapper_general).on('change', '.custom-file-input-image', function(e) {
                ...
                if (numb > 1.0) { //change file limit here (MB)
                    ...
                    // alert('Ralat! Fail anda melebihi 1mb. Saiz fail anda adalah: ' + numb +' MB');
                    $('#note_message').html(
                        'Ralat! Fail anda melebihi <b>1mb</b>. Saiz fail anda adalah: <b>' + numb +
                        ' MB</b>');
                    $("#validation_submit_permohonan").modal();
