      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="border card">
            <div class="border card-header bg-info border-dark">
              <h4 class="text-white m-b-0" style="text-align: center;">Pengumuman</h4>
            </div>
            <div class="border card-body border-dark h-200">
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="border card-header bg-info border-dark">
              <h4 class="text-white m-b-0" style="text-align: center;">Jumlah Dana Yang Diterima</h4>
            </div>
            <div class="border card-body border-dark" style="padding-top: 9%">
          ...
          <div class="card">
            <div class="border card-header bg-info border-dark">
                <h4 class="text-white m-b-0" style="text-align: center;">Jumlah Dana Yang Telah Diluluskan</h4>
            </div>
            <div class="border card-body border-dark" style="padding-top: 9%">
