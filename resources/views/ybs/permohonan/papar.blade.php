                      ...
                      <div class="card-body border border-info">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md">
                            ...
                            <input type="hidden" name="permohonan_id" value="{{ $permohonan->id }}" readonly="">
                            <button type="submit" class="btn waves-effect waves-light btn-info btn-block"><svg class="svg-inline--fa fa-print fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="print" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M448 192V77.25c0-8.49-3.37-16.62-9.37-22.63L393.37 9.37c-6-6-14.14-9.37-22.63-9.37H96C78.33 0 64 14.33 64 32v160c-35.35 0-64 28.65-64 64v112c0 8.84 7.16 16 16 16h48v96c0 17.67 14.33 32 32 32h320c17.67 0 32-14.33 32-32v-96h48c8.84 0 16-7.16 16-16V256c0-35.35-28.65-64-64-64zm-64 256H128v-96h256v96zm0-224H128V64h192v48c0 8.84 7.16 16 16 16h48v96zm48 72c-13.25 0-24-10.75-24-24 0-13.26 10.75-24 24-24s24 10.74 24 24c0 13.25-10.75 24-24 24z"></path></svg><!-- <i class="fas fa-print"></i> Font Awesome fontawesome.com --> &nbsp;&nbsp; Cetak Permohonan</button>
                            </form>
                          </div>
                          <div class="col-md-2"></div>
                        </div>
                        ...
                        <div class="row" style="padding-top: 10px;">
                          ...
                          <div class="col-md" style="padding-top: 5px;">
                            <button type="button" class="btn waves-effect waves-light btn-success btn-block" id="sahkan_button" data-toggle="modal" data-target="#confirmation_luluskan_permohonan">Sokong Permohonan</button>
                          </div>
                          <div class="col-md-2"></div>
                        </div>
